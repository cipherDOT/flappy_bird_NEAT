# learning AI by making a game and using genetic algorithm (NEAT)...
...
def draw_window(win, birds, pipes, base, score, gen):
    ...
    win.blit(text1, (D_WIDTH - 10 - text1.get_width(), 10))

    text2 = STAT_FONT.render("Gen: " + str(gen), 1, (255, 255, 255))
    win.blit(text2, (10, 10))

    # text3 = STAT_FONT.render("Alive: " + str(alive), 1, (255, 255, 255))
    # win.blit(text3, (70, 10))
...
def main(genomes, config):
    ...
    while run:
        ...
        base.move()
        draw_window(display, birds, pipes, base, score = score, gen = GEN)
